...
$headers = array(
	array($lang->lang('th_date'), 'news_date', 'ASC'),
	array($lang->lang('th_userid'), 'user_name', 'ASC'),
	array($lang->lang('th_catid'), 'news_catid', 'ASC'),
	array($lang->lang('th_langid')),
	array($lang->lang('th_title')),
	array($lang->lang('th_hidden'), 'news_options&'.GWF_News::HIDDEN, 'DESC'),
);

echo $tVars['page_menu'];

$lang_visible = $lang->lang('th_visible');
$lang_hidden = $lang->lang('th_hidden');
...
$buttons = GWF_Button::add($lang->lang('btn_add'), GWF_WEB_ROOT.'news/add');
