...
if ($tVars['can_sign'])
{
	echo GWF_Button::wrap(GWF_Button::generic($lang->lang('btn_sign'), $tVars['href_sign_news']));
}
...
//	{
//		$button_show_forum = GWF_Button::generic($lang->lang('btn_forum'), $news->hrefThread($tid));
...
if ($is_staff)
{
	...
	$buttons .= GWF_Button::generic($lang->lang('btn_admin_section'), $tVars['module']->getAdminSectionUrl());
