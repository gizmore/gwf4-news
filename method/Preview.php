...
final class News_Preview extends GWF_Method
{
	...
	{
		return 
			'RewriteRule ^newsletter/preview/text$ index.php?mo=News&me=Preview&mode=text [QSA]'.PHP_EOL.
			'RewriteRule ^newsletter/preview/html$ index.php?mo=News&me=Preview&mode=html [QSA]'.PHP_EOL;
	}
