...
final class News_Sign extends GWF_Method
{
	...
	{
		return 
			'RewriteRule ^newsletter/subscribe$ index.php?mo=News&me=Sign&sign=sign [QSA]'.PHP_EOL.
//			'RewriteRule ^newsletter/unsubscribe_now$ index.php?mo=News&me=Sign&_unsign=now'.PHP_EOL.
			'RewriteRule ^newsletter/unsubscribe/([a-zA-Z0-9\._@\+\-]+)/([a-zA-Z0-9]+)$ index.php?mo=News&me=Sign&unsign=$2&email=$1 [QSA]'.PHP_EOL;
	}
