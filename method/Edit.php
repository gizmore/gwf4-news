...
final class News_Edit extends GWF_Method
{
	...
	{
		return
			'RewriteRule ^news/edit$ index.php?mo=News&me=Edit [QSA]'.PHP_EOL.
			'RewriteRule ^news/edit/([0-9]+)-[^/]+/langid-([0-9]+) index.php?mo=News&me=Edit&newsid=$1&langid=$2 [QSA]'.PHP_EOL;
	}
