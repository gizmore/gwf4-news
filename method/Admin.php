...
final class News_Admin extends GWF_Method
{
	...
	{
		return 
			'RewriteRule ^news/admin$ index.php?mo=News&me=Admin&page=1&by=date&dir=DESC [QSA]'.PHP_EOL.
			'RewriteRule ^news/admin/page/([0-9]+)/by/([a-zA-Z_,]+)/([DEASC,]+)$ index.php?mo=News&me=Admin&page=$1&by=$2&dir=$3 [QSA]'.PHP_EOL;
	}
